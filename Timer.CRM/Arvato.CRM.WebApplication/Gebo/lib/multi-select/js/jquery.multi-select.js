  ...
  * ====================== */
  ...
  MultiSelect.prototype = {
    ...
    init: function(){
      ...
      that.$container = $('<div id="ms-' + ms.attr('id') + '" class="ms-container"></div>');
      that.$selectableContainer = $('<div class="ms-selectable"></div>');
      that.$selectionContainer = $('<div class="ms-selection"></div>');
      that.$selectableUl = $('<ul class="ms-list"></ul>');
      that.$selectionUl = $('<ul class="ms-list"></ul>');
      that.scrollTo = 0;
