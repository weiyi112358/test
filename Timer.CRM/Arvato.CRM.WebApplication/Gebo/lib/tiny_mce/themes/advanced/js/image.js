var ImageDialog = {
	preInit : function() {
		...
		if (url = tinyMCEPopup.getParam("external_image_list_url"))
			document.write('<script language="javascript" type="text/javascript" src="../../../../../../lib/tiny_mce/themes/advanced/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
	},
