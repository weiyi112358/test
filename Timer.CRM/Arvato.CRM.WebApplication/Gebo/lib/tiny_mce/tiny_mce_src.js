	...
	tinymce.create('tinymce.ui.Button:tinymce.ui.Control', {
		...
		renderHTML : function() {
			...
			if (s.image && !(this.editor  &&this.editor.forcedHighContrastMode) )
				h += '<span class="mceIcon ' + s['class'] + '"><img class="mceIcon" src="../../../lib/tiny_mce/' + s.image + '" alt="' + DOM.encode(s.title) + '" /></span>' + (l ? '<span class="' + cp + 'Label">' + l + '</span>' : '');
			else
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			if (s.document_base_url != tinymce.documentBaseURL)
				t.iframeHTML += '<base href="../../../lib/tiny_mce/' + t.documentBaseURI.getURI() + '" />';
			...
			for (i = 0; i < t.contentCSS.length; i++) {
				t.iframeHTML += '<link type="text/css" rel="stylesheet" href="../../../lib/tiny_mce/' + t.contentCSS[i] + '" />';
			}
