(function() {
	...
	if (url = tinyMCEPopup.getParam("media_external_list_url"))
		document.write('<script language="javascript" type="text/javascript" src="../../../../../../lib/tiny_mce/plugins/media/js/' + tinyMCEPopup.editor.documentBaseURI.toAbsolute(url) + '"></script>');
