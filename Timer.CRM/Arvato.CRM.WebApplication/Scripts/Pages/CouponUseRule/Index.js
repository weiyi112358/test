...
$(function () {
    ...
    $('#dt_Table').on('click', '.wakeupRule', function () {
        ...
        $.dialog("确认唤醒吗?", {
            ...
            ajax("/CouponUseRule/ChangeCouponStatus", { Id: id }, showResult);
        })
    });
    //休眠
    ...
    $('#dt_Table').on('click', '.approveRule', function () {
        ...
        $.dialog("确认审核此规则吗?", {
            ...
            ajax("/CouponUseRule/ApproveCouponById", { Id: id, active: 1 }, showResult);
        })
    });
    //作废
    $('#dt_Table').on('click', '.voidRule', function () {
        ...
        $.dialog("确认作废此规则吗?", {
            ...
            ajax("/CouponUseRule/ApproveCouponById", { Id: id, active: 2 }, showResult);
        })
    });
    //删除
    $('#dt_Table').on('click', '.deleteRule', function () {
        ...
        $.dialog("确认删除吗?", {
            ...
            ajax("/CouponUseRule/DeleteCouponById", { Id: id }, showResult);
        })
    });
