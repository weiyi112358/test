$(function () {
    ...
    $("#export").click(function () {
        $("#exportForm")[0].action = "/Report/ExportMachineOilCarryRate";
...
function searchMem() {
    ...
    if (!dtSearch) {
        dtSearch = $('#dt_search').dataTable({
            sAjaxSource: '/Report/GetMachineOilCarryRate',
            bAutoWidth: false,
            bSort: false,   //不排序
            ...
            aoColumns: [
               ...
               {
                   data: "Name", title: "自采保养台次搭载率", "sClass": "center Total_Mem", sortable: false, render: function (r) {
                       return formatNumber(r);
                   }
               },
               {
                   data: "Age", title: "自采保养金额搭载率", "sClass": "center Total_Mem", sortable: false, render: function (r) {
                       return formatNumber(r);
                   }
               },
            ],
