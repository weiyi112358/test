            ...
            aoColumns: [
                ...
                //},
                {
                    data: null, title: "操作", sortable: false, render: function (obj) {
                        ...
                        if (obj.Active == false && obj.Lock == true && obj.isConfirm_Unlock == null)
                            return "<button class=\"btn\" id=\"btnActive\" onclick=\"viewDetail('" + obj.MemberID + "')\">查看明细</button> <button class=\"btn\" id=\"btnLock\" onclick=\"showCardLock('" + obj.CardNo + "','" + obj.Str_Attr_3 + "','" + obj.Active + "','" + obj.Lock + "','" + obj.MemberID + "')\">保存</button> "
                        else if (obj.Active == false && obj.Lock == true && obj.isConfirm_Unlock == false)
